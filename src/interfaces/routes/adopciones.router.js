...
const { getAllController, getController, createController, updateController, updateEstadoController, deleteController } = require('../controllers/adopciones.controller');
