const { getAllCase, getCase, createCase, updateCase, updateEstado, destroyCase } = require('../../application/adopciones/adopciones.cases.js');
...
module.exports = { getAllController, getController, createController, updateController, updateEstadoController, deleteController };