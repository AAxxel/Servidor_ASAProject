const { getAllCase, getCase, createCase, updateCase, desactivarCase } = require('../../application/usuarios/usuarios.cases.js');
...
module.exports = { getController, getAllController, createController, updateController, desactivarController, deleteController };